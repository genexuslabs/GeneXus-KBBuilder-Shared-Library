    ...
    <div class="gray-container">
        <div class="jenkins-header">
            ...
            <div class="jenkins-header-tittle">
                ...
                <div class="jenkins-header-tittleline">
                    <p style="color: ${buildColor};" id="build-result" >Build #${buildNumber} <strong>${buildResult}</strong></p>
                </div>
            </div>
            <div class="jenkins-header-outputlink">
                <a href="${jenkinsUrl}">
                    <img id="jenkins-output" alt="arrow" src="https://raw.githubusercontent.com/Enz1n/Images/main/images/Purple%20Magenta%20Bold%20Shapes%20Sales%20Proposal%20Sales%20Presentation%20(3)-PhotoRoom%20(1).png" id="arrow">
                </a>
            </div>
        </div>
